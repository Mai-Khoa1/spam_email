...
class SpamDetector:
    ...
    def is_spam(self, message_):
        ...
        # Make prediction
        prediction = self.model.predict([processed_message])
...
class VotingSpamDetector:
    ...
    def is_spam(self, message_):
        return self.predict_with_details(message_)['is_spam']

    def predict_with_details(self, message_):
        ...
        return {
            'is_spam': weighted_spam_score > decision_threshold,
            'votes': vote_descriptions,
            'weighted_score': weighted_spam_score,
            'decision': decision,
        }
